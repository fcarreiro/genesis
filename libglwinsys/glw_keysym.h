#ifndef __GLW_KEYSYM_H__
#define __GLW_KEYSYM_H__
...
typedef enum {
	// they DO match ASCII chars, thanks to SDL (www.libsdl.org)
	// for this list: its fully compatible with SDL
	GLWK_UNKNOWN		= 0,
	GLWK_FIRST			= 0,
	GLWK_BACKSPACE		= 8,
	GLWK_TAB			= 9,
...
typedef enum {
	...
	// add keys here (such as middle mouse ball)
	GLWMK_LAST
} glw_mousekey;
