...
//////////////////////////////////////////////////////////////////////////
// CalculateFrustum() : This extracts our frustum from the matrices.
//////////////////////////////////////////////////////////////////////////
...
//////////////////////////////////////////////////////////////////////////
// PointInFrustum() : This determines if a point is inside of the frustum
//////////////////////////////////////////////////////////////////////////
...
//////////////////////////////////////////////////////////////////////////
// SphereInFrustum() : This determines if a sphere is inside of our frustum.
//////////////////////////////////////////////////////////////////////////
...
//////////////////////////////////////////////////////////////////////////
// CubeInFrustum() : This determines if a cube is in or around our frustum.
//////////////////////////////////////////////////////////////////////////
...
//////////////////////////////////////////////////////////////////////////
// BoxInFrustum() : Checks if a box is inside the frustum or not
//////////////////////////////////////////////////////////////////////////
...
bool CFrustum::BoxInFrustum(float x, float y, float z, float width, float height, float depth)
{
	...
	for(int i = 0; i < 6; i++ )
	{
		if(m_Frustum[i][A] * (x - w2) + m_Frustum[i][B] * (y - h2) + m_Frustum[i][C] * (z - d2) + m_Frustum[i][D] > 0)
		   continue;
		if(m_Frustum[i][A] * (x + w2) + m_Frustum[i][B] * (y - h2) + m_Frustum[i][C] * (z - d2) + m_Frustum[i][D] > 0)
		   continue;
		if(m_Frustum[i][A] * (x - w2) + m_Frustum[i][B] * (y + h2) + m_Frustum[i][C] * (z - d2) + m_Frustum[i][D] > 0)
